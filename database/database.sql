...
CREATE TABLE inspecoes (
    ...
    is_mock BOOLEAN DEFAULT TRUE COMMENT 'Indicador booleano: sinaliza se o registro é um dado simulado (TRUE) ou real (FALSE).',

    FOREIGN KEY (elevador_id)
        REFERENCES elevadores(id),
    FOREIGN KEY (inspetor_id)
        REFERENCES inspetores(id)
) COMMENT = 'Massa de dados sintética gerada exclusivamente para validação da arquitetura e homologação de pipelines. Não contém registros reais de produção.';
...
VALUES
(1,1,'2026-05-01','07:10:00','LIBERADO','Inspeção sem anomalias.', TRUE),
(1,2,'2026-05-02','07:08:00','LIBERADO','Equipamento normal.', TRUE),
(1,3,'2026-05-03','07:15:00','LIBERADO_COM_RESTRICAO','Ruído observado no sistema de tração.', TRUE),
(1,4,'2026-05-04','07:05:00','INTERDITADO','Falha no trava-quedas.', TRUE),
(1,5,'2026-05-05','07:11:00','LIBERADO','Após correção do trava-quedas.', TRUE);
...
) COMMENT = 'Massa de dados sintética de falhas e desvios gerada exclusivamente para validação técnica da arquitetura de inteligência.';
